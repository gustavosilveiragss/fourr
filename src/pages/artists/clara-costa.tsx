        ...
        <div className="bg-slate-200 flex-col">
          <DrawerLayout>
                ...
                <div className="col-span-2 flex flex-col">
                  <div className="px-4">
                    ...
                    <h1 className="text-xl font-bold text-gray-700">
                      Algumas das artes de Clara Costa
                    </h1>
                  </div>
                  ...
                  <div className="px-4">
                    ...
                    <h1 className="text-xl font-bold text-gray-700 mb-4">
                      Os pacotes que Clara Costa disponibiliza
                    </h1>
                  </div>
                  ...
                  <div className="flex flex-row disable-hover flex-wrap gap-5 pt-4 items-stretch justify-around">
                    <div className="card card-compact  border-opacity-50 w-full md:w-80 bg-slate-200 border border-slate-500">
                      <div className="card-body text-gray-800 text-center">
                        ...
                        <h2 className="font-bold text-xl">R$ 180,00</h2>
                    ...
                    <div className="card card-compact  border-opacity-50 w-full md:w-80 bg-slate-200 border border-slate-500">
                      <div className="card-body text-gray-800 text-center">
                        ...
                        <h2 className="font-bold text-xl">R$ 300,00</h2>
                        <div className="card-actions justify-end">
                          <button className="btn btn-success w-full">
                            Contratar Serviço
                          </button>
                    ...
                    <div className="card card-compact  border-opacity-50 w-full md:w-80 bg-slate-200 border border-slate-500">
                      <div className="card-body text-gray-800 text-center">
                        ...
                        <h2 className="font-bold text-xl">R$ 460,00</h2>
                        <div className="card-actions justify-end">
                          <button className="btn btn-success w-full">
                            Contratar Serviço
                          </button>
            ...
            <div className="px-4 mb-8">
              ...
              <h1 className="text-xl font-bold text-gray-700">
                O que os clientes acharam dos serviços de Clara Costa?
              </h1>
            </div>
